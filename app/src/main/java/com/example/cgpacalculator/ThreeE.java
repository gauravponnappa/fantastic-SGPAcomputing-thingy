...
public class ThreeE extends AppCompatActivity {
    ...
    @Override
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_three_e);
        ...
        if (branch==1)
        {
            sub2 = findViewById(R.id.sub61);
            sub2.setText("18EC61");
            sub3 = findViewById(R.id.sub62);
            sub3.setText("18EC62");
            sub4 = findViewById(R.id.sub63);
            sub4.setText("18EC63");
            sub5 = findViewById(R.id.sub64);
            sub5.setText("18EC64");
            sub6 = findViewById(R.id.sub65);
            sub6.setText("18EC65");
            sub7 = findViewById(R.id.sub66);
            sub7.setText("18EC66");
            sub8 = findViewById(R.id.sub67);
            sub8.setText("18ECL67");
            sub9 = findViewById(R.id.sub68);
            sub9.setText("18ECL68");
        ...
        if (branch==2)
        {
            ...
            sub7.setText("18CS66");
            sub8 = findViewById(R.id.sub67);
            sub8.setText("18CSL67");
            sub9 = findViewById(R.id.sub68);
            sub9.setText("18CSL68");
        ...
        if (branch==3)
        {
            ...
            sub7.setText("18IS66");
            sub8 = findViewById(R.id.sub67);
            sub8.setText("18ISL67");
            sub9 = findViewById(R.id.sub68);
            sub9.setText("18ISL68");
        ...
        if (branch==4)
        {
            ...
            sub7.setText("18CV66");
            sub8 = findViewById(R.id.sub67);
            sub8.setText("18CVL67");
            sub9 = findViewById(R.id.sub68);
            sub9.setText("18CVL68");
        ...
        if (branch==5)
        {
            ...
            sub7.setText("18ME66");
            sub8 = findViewById(R.id.sub67);
            sub8.setText("18MEL67");
            sub9 = findViewById(R.id.sub68);
            sub9.setText("18MEL68");
        ...
        if (branch==6)
        {
            ...
            sub7.setText("18EE66");
            sub8 = findViewById(R.id.sub67);
            sub8.setText("18EEL67");
            sub9 = findViewById(R.id.sub68);
            sub9.setText("18EEL68");
            ...
            calc.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mtest1.equals("") || mtest2.equals("") || mtest3.equals("") || mtest4.equals("") || mtest5.equals("") || mtest6.equals("") || mtest7.equals("") || mtest8.equals("")) {
                        Toast.makeText(ThreeE.this, "please fill all the fields", Toast.LENGTH_LONG).show();
                    }
                    else {
                        ...
                        if (mr1>100||mr2>100||mr3>100||mr4>100||mr5>100||mr6>100||mr7>100||mr8>100){
                            ...
                            Toast.makeText(ThreeE.this, "INVALID MARKS GIVEN", Toast.LENGTH_LONG).show();
                            ...
                            Intent intent = new Intent(ThreeE.this, results.class);
